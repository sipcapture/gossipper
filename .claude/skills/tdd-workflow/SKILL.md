---
name: tdd-workflow
description: Use this skill when writing new features, fixing bugs, or refactoring code. Enforces test-driven development: failing test first (Go table-driven tests with -race, Vitest for UI), then implementation.
